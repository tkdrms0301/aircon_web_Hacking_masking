...
<table width="587" border="0" cellspacing="0" cellpadding="0">
  <tr>
      <td width="218"><img src="../img/main/new/s-search.jpg" width="218" height="74"></td>
	  <td width="359" background="../img/main/new/bg.gif"><table width="359" border="0" cellspacing="0" cellpadding="0">
          <tr> 
            <td height="32"> &nbsp; 
              <!------------------대분류------------->
              <select name="Category1" onChange="getValue('catfrm',this,0,1,'document.reg_form.Category2',0)">
                ...
                <?
$sqlstr = "SELECT * FROM category WHERE category < 5  ORDER BY UID ASC";
