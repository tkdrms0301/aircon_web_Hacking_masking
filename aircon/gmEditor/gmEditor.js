...
// IE ? Nets
str = "<style>body{font-family: Tahoma,Verdana,Arial;font-size: 11px;color: #555555;margin: 0px}td{font-size :11px; font-family: Tahoma,Verdana,Arial;border:1 dashed C6C3C6}p{margin-top:1px;margin-bottom:1px;}table {border:1 dashed C6C3C6}</style>\n";
...
function createHTML(val,key){
	...
	switch(key){
		...
		case 16: // Image Uploaded-2
			width = 400; height = !os ? 460 : 434; filename = 'upfile2.php';
		break;
	}
