...
<BODY scroll=yes leftmargin="1" marginwidth="1" topmargin="1" marginheight="1" onload="url_write();">
...
<table border="0" cellpadding="8" cellspacing="5" width="100%" height="100%" bgcolor="#E6E8EB">
	<form name="add_form" action="upfile2_ok.php" method="post" enctype="multipart/form-data" target="editor_hidden">
