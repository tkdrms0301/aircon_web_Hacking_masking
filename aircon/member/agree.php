		...
		<tr>
          ...
          <td align="right" valign="top">
		     <table width="700" border="0" cellspacing="0" cellpadding="0">
              <tr> 
                <td width="700"><img src="../img/member/stitle.gif" width="700" height="53"> 
                </td>
              </tr>
              <tr> 
                <td align="center" valign="top"> 
                  ...
                  <table width="626" border="0" cellspacing="0" cellpadding="0" align="center">
                    ...
                    <tr>
                      <td><img src="../img/member/stitle_st.gif" width="86" height="39"></td>
                    </tr>
                    <tr>
                      <td align="center" valign="top">
                        <table width=626 border=0 cellPadding=0 cellSpacing=10 
                        bgColor=#F2F2F2>
                          <tbody>
                            <tr>
                              <td align=center bgColor=#ffffff>
                                <textarea name=textarea rows=25 cols=100  style="font-size:12; color:#444444; border: 1px solid #E0E0E0">제1조(목적)

이 약관은 탑에어컨 회사(전자상거래 사업자)가 운영하는 탑에어컨 사이버 몰 (이하 "몰"이라 한다)에서 제공하는 인터넷 관련 서비스(이하 "서비스"라 한다)를 이용함에 있어 사이버 몰과 이용자의 권리와 의무 및 책임사항을 규정함을 목적으로 합니다. 
※「PC통신, 무선 등을 이용하는 전자상거래에 대해서도 그 성질에 반하지 않는 한 이 약관을 준용합니다」

제2조(정의)

①"몰" 이란 탑에어컨 회사가 재화 또는 용역(이하 "재화등"이라 함)을 이용자에게 제공하기 위하여 컴퓨터등 정보통신설비를 이용하여 재화등을 거래할 수 있도록 설정한 가상의 영업장을 말하며, 아울러 사이버몰을 운영하는 사업자의 의미로도 사용합니다.
...
function Register()
{
	...
	if(!agree.Contract[0].checked) { alert('약관에 동의하지 않으면 회원가입을 하실수 없습니다.'); return false;}
	agree.submit();
}
</script>
<form name="agree" method="get" action="../member/mem_join.php" onsubmit="return Register()">
                        <img src="../img/member/agree.gif" width="173" height="17" align="absmiddle"><input type="radio" name="Contract" value="1">
                        동의함
                        <input type="radio" name="Contract" value="2">
                        동의안함<br>
                        <br>
                        <input type="image"  src="../img/member/ok_btn.jpg" border="0"></a>&nbsp;&nbsp;<A HREF="../main/main.php"><img src="../img/member/cancel_btn.jpg"></A>
</form>
						</td>
                    </tr>
                  </table>
