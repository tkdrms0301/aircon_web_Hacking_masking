...
function selected()
{
	window.opener.order.bz_juso1.value = form.addr1.value ;  
	window.opener.order.bz_zip1.value = form.addr2.value ;  
	window.opener.order.bz_zip2.value = form.addr3.value ;  
	window.opener.order.bz_juso2.focus();
	self.close();
}
-->
</script>
