...
function selected()
{
	window.opener.order.rjuso1.value = form.addr1.value ;  
	window.opener.order.rzip1.value = form.addr2.value ;  
	window.opener.order.rzip2.value = form.addr3.value ;  
	window.opener.order.rjuso2.focus();
	self.close();
}
-->
</script>
